...
from src.providers.carbon_intensity.intensity_provider import IntensityMeasurementData, ResolvedLocation
from src.providers.carbon_intensity.country_defaults import GLOBAL_AVERAGE_INTENSITY, COUNTRY_INTENSITY_DEFAULTS
