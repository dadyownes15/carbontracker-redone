...
from src.providers.power.providers.cpu.sim_cpu import SimulatedCPUProvider
from src.providers.power.providers.gpu.sim_gpu import SimulatedGPUProvider
...
# create_intensity_thread is now imported from src.providers.carbon_intensity.factory
